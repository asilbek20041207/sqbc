...
@section('content')
    <section class="content content--mt">
        <form action="{{ route('information.store') }}" method="POST" class="form" enctype="multipart/form-data">
            @csrf
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="desc1_ru" name="desc1_ru" required
                                  ...
                                  class="form__textarea kirano-w-100">{{ old('desc1_ru') }}</textarea>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="desc1_uz" name="desc1_uz" required
                                  ...
                                  class="form__textarea kirano-w-100">{{ old('desc1_uz') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="desc2_ru" name="desc2_ru" required
                                  placeholder="Введите текст"
                                  class="form__textarea kirano-w-100">{{ old('desc2_ru') }}</textarea>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="desc2_uz" name="desc2_uz" required
                                  placeholder="Matnni kiriting"
                                  class="form__textarea kirano-w-100">{{ old('desc2_uz') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-md-6 mb-4">
                        <div class="form__field">
                            <label for="image1" class="form__label">Файл 1</label>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-md-6 mb-4">
                        <div class="form__field">
                            <label for="image2" class="form__label">Файл 1</label>
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="values_desc1_ru" name="values_desc1_ru" required
                                  placeholder="Введите текст"
                                  class="form__textarea kirano-w-100">{{ old('values_desc1_ru') }}</textarea>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="values_desc1_uz" name="values_desc1_uz" required
                                  placeholder="Matnni kiriting"
                                  class="form__textarea kirano-w-100">{{ old('values_desc1_uz') }}</textarea>
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="values_desc2_ru" name="values_desc2_ru" required
                                  placeholder="Введите текст"
                                  class="form__textarea kirano-w-100">{{ old('values_desc2_ru') }}</textarea>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="values_desc2_uz" name="values_desc2_uz" required
                                  placeholder="Matnni kiriting"
                                  class="form__textarea kirano-w-100">{{ old('values_desc2_uz') }}</textarea>
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="values_desc3_ru" name="values_desc3_ru" required
                                  placeholder="Введите текст"
                                  class="form__textarea kirano-w-100">{{ old('values_desc3_ru') }}</textarea>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="values_desc3_uz" name="values_desc3_uz" required
                                  placeholder="Matnni kiriting"
                                  class="form__textarea kirano-w-100">{{ old('values_desc3_uz') }}</textarea>
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="values_desc4_ru" name="values_desc4_ru" required
                                  placeholder="Введите текст"
                                  class="form__textarea kirano-w-100">{{ old('values_desc4_ru') }}</textarea>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="values_desc4_uz" name="values_desc4_uz" required
                                  placeholder="Matnni kiriting"
                                  class="form__textarea kirano-w-100">{{ old('values_desc4_uz') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-md-6 mb-4">
                        <div class="form__field">
                            <label for="charter" class="form__label">Файл 1</label>
                            <input type="file" id="charter" name="charter" required
                                   class="form__input--file kirano-w-100">
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-md-6 mb-4">
                        <div class="form__field">
                            <label for="image3" class="form__label">Файл 1</label>
                    ...
                    <div class="col-xxl-3 col-md-6 mb-4">
                        <div class="form__field">
                            <label for="image4" class="form__label">Файл 2</label>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-md-6 mb-4">
                        <div class="form__field">
                            <label for="company_structure_ru" class="form__label">Файл 1 RU</label>
                            <input type="file" id="company_structure_ru" name="company_structure_ru" required
                                   class="form__input--file kirano-w-100">
                    ...
                    <div class="col-xxl-3 col-md-6 mb-4">
                        <div class="form__field">
                            <label for="company_structure_uz" class="form__label">Файл 1 UZ</label>
                            <input type="file" id="company_structure_uz" name="company_structure_uz" required
                                   class="form__input--file kirano-w-100">
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-md-6 mb-4">
                        <div class="form__field">
                            <label for="supervisory_board" class="form__label">Файл 1</label>
                            <input type="file" id="supervisory_board" name="supervisory_board" required
                                   class="form__input--file kirano-w-100">
