...
@section('content')
    <section class="content content--mt">
        <form action="{{ route('projects.update', $project) }}" method="POST" class="form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="container-fluid">
                <div class="row mb-sm-4">
                    <h1 class="kirano-title-h1 mb-4">Редактировать проект</h1>
                ...
                <div class="row mb-4">
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="description_ru" name="description_ru" required
                                  ...
                                  class="form__textarea kirano-w-100">{{ $project->description_ru }}</textarea>
                    ...
                    <div class="col-xl-5 col-md-6 mb-4">
                        ...
                        <textarea rows="8" id="description_uz" name="description_uz" required
                                  ...
                                  class="form__textarea kirano-w-100">{{ $project->description_uz }}</textarea>
