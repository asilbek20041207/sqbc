            ...
            <form action="{{ route('socials.update', $social) }}" method="POST">
                ...
                <div class="row mb-3 top-section">
                    ...
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="telegram" name="telegram" value="{{ $social->telegram }}"
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="instagram" name="instagram" value="{{ $social->instagram }}"
                               placeholder="Вставьте ссылку"
                               class="form__input form__input--gray kirano-w-100">
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="mail" name="mail" value="{{ $social->mail }}"
                               placeholder="Вставьте ссылку"
                               class="form__input form__input--gray kirano-w-100">
