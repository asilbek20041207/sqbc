            ...
            <form action="{{ route('contacts.update', $contact) }}" method="POST">
                ...
                <div class="row mb-3 top-section">
                    ...
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="tel" id="phone" name="phone" value="{{ $contact->phone }}" placeholder="+998"
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="work_time_ru" name="work_time_ru" value="{{ $contact->work_time_ru }}"
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="work_time_uz" name="work_time_uz" value="{{ $contact->work_time_uz }}"
                               placeholder="Время работы"
                               class="form__input form__input--gray kirano-w-100">
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="address_ru" name="address_ru" value="{{ $contact->address_ru }}"
                               placeholder="Адрес"
                               class="form__input form__input--gray kirano-w-100">
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="address_uz" name="address_uz" value="{{ $contact->address_uz }}"
                               placeholder="Адрес"
                               class="form__input form__input--gray kirano-w-100">
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="geolocation" name="geolocation" value="{{ $contact->geolocation }}"
