            ...
            <form action="{{ route('counters.store') }}" method="POST">
                ...
                <div class="row top-section mb-3">
                    ...
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="google_tag" name="google_tag" value="{{ old('google_tag') }}"
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="yandex_metrics" name="yandex_metrics" value="{{ old('yandex_metrics') }}"
                               placeholder="Вставьте ссылку"
                               class="form__input form__input--gray kirano-w-100">
                ...
                <div class="row mb-3">
                    <div class="col-xxl-5 col-xl-6 col-md-8 col-sm-10">
                        ...
                        <input type="text" id="facebook_pixel" name="facebook_pixel" value="{{ old('facebook_pixel') }}"
                               placeholder="Вставьте ссылку"
                               class="form__input form__input--gray kirano-w-100">
